...
/** This class is using <b>author-mapping.csv</b> document, generated by [[service.authormapper.AuthorMapperService]], to map given SWS document
  * identifier to author document in PublishOne
  */
@Singleton
